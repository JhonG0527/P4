...
Ob41_pos = [2/50, 31.5/36, 3/50, 1.4/36]; % Directory:
Ob42_pos = [2/50, 28.5/36, 25/50, 1.4/36]; % Directory Path

Ob4_pos = [2/50, 30/36, 14/150, 1.4/36]; % No de imagenes
Ob43_pos = [10/50, 30/36, 20/150, 1.4/36]; % No de GPS info
Ob44_pos = [18/50, 30/36, 20/150, 1.4/36]; % No de int
